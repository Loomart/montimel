...
CREATE TABLE order_items (
    ...
    product_id UUID REFERENCES products(id), -- Assuming a products table exists or mapping to items
...
ON products FOR ALL USING (
  -- Replace with your admin check logic (e.g., checking a custom claim or a table)
